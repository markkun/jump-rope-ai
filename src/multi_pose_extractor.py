...
class MultiPoseExtractor:
    def __init__(self):
        # 检测模型（YOLOX + RTMPose）
        self.det_model = init_det('yolox_l_8x8_300e_coco.py',
                                  'yolox_l_8x8_300e_coco_20211126_140254-ee22ba79.pth',
                                  device='cuda')
        self.pose_model = init_model('rtmpose-s_8xb256-420e_coco-256x192.py',
                                     'rtmpose-s_simcc-coco_pt-aic-coco_120e-256x192-f1d8ece0_20230126.pth',
                                     device='cuda')
